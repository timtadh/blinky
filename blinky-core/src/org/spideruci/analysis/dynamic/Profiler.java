...
public class Profiler {
  ...
  public static synchronized void setLogFlags(final boolean value) {
    logMethodEnter =
        logMethodExit =
            logMethodInvoke =
                logSourceLineNumber =
                                    ...
                                    logField =
                                        logType =
                                            logSwitch =
                                                ...
                                                logEnterRuntimeSign = log = value;
  }

  public static synchronized void initProfiler(String args) {
    if (REAL_ERR == null) {
      REAL_ERR = System.err;
    }
  ...
  public static synchronized void reguard(boolean guard) {
    $guard1$ = false; // TODO shouldn't this be guard instead of false?
  }

  public static final String GUARD = "guard";

  public static synchronized boolean guard() {
  ...
  public static synchronized void printLnMethodEnterLog(
      String className, String methodName, String instruction, String tag) {
  ...
  public static synchronized void printLnMethodExitLog(
      String className, String methodName, String instruction, String tag) {
    if ($guard1$) return;
  ...
  public static synchronized void printlnInvokeLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logMethodInvoke) {
  ...
  public static synchronized void printlnCompleteLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logMethodInvoke) {
  ...
  public static synchronized void printlnVarLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logVar) {
  ...
  public static synchronized void printlnVarLog(String varId, String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logVar) {
  ...
  public static synchronized void printlnField(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logField) {
  ...
  public static synchronized void printlnField(
      String fieldOwnerId, String fieldId, String instruction, String tag) {
  ...
  public static synchronized void printlnZeroOpLog(String instruction, String tag, String type) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logZero) {
  ...
  public static synchronized void printlnConstantLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logConstant) {
  ...
  public static synchronized void printlnTypeLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logType) {
  ...
  public static synchronized void printlnSwitchLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logSwitch) {
  ...
  public static synchronized void printlnArrayLog(
      Object arrayref, int index, String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logZero) {
  ...
  public static synchronized void printlnArrayLog(
      Object arrayref, int index, String elementId, String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logZero) {
      int length = Array.getLength(arrayref);
  ...
  public static synchronized void printlnJumpLog(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logJump) {
  ...
  public static synchronized void printlnIinc(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
    if (logVar) {
  ...
  public static synchronized void printLnLineNumber(String instruction, String tag) {
    if ($guard1$) return;
    boolean guard = guard();
  ...
  public static synchronized void printLnArgLog(
      String argType, String index, boolean isFirst, boolean isLast) {
    if ($guard1$) return;
    boolean guard = guard();
  ...
  public static synchronized void printLnInvokeArgLog(String argType, String index) {
    if ($guard1$) return;
    boolean guard = guard();
  ...
  private static synchronized boolean threadCheck(long... threadIds) {
  ...
  public static synchronized void printTraceCount() {
    $guard1$ = true;
  ...
  public static synchronized String getHash(Object obj) {
    int id = System.identityHashCode(obj);
    return String.valueOf(id);
  }

  public static final String GETTYPENAME = "getTypeName";
  public static final String GETTYPENAME_DESC =
      "(" + Config.OBJECT_DESC + Config.STRING_DESC + ")" + Config.STRING_DESC;

  public static synchronized String getTypeName(Object obj, String staticType) {
    if (obj == null) {
      return staticType + "#0";
    } else {
  ...
  public static synchronized String getArrayTypeName(Object array, String staticType) {
    if (array == null) {
      return staticType + "#0";
    } else {
  ...
  /** ************************isMain(String[])?************************* */
  public static synchronized void unsetGuard1() {
    thread = Thread.currentThread().getId();
    time = System.currentTimeMillis();
    $guard1$ = false;
  }

  public static synchronized void setGuard1() {
    printTraceCount();
    $guard1$ = true;
  }

  /**
   * Checks if the method is main(String[]); If so it returns a true value suggesting that we unset
   * the guard that prevents the execution of the probes that were placed via instrumentation.
   *
   * @return True if current method is main(String[]) False if current method is not main(String[])
   *     <br>
   *     current method is defined using mid.MethodName and mid.MethodDescription
   */
  public static synchronized boolean getUnsetGuardCondition(String ownerName, String methodName) {
  ...
  /**
   * Checks if the method is main(String[]); If so it returns a true value suggesting that we set
   * the guard that prevents the execution of the probes that were placed via instrumentation.
   *
   * @return True if current method is main(String[]) False if current method is not main(String[])
   *     <br>
   *     current method is defined using mid.MethodName and mid.MethodDescription
   */
  public static synchronized boolean getSetGuardCondition(String ownerName, String methodName) {
    if (entryMethod != null && entryClass != null) {
      return methodName.equals(entryMethod) && entryClass.equals(ownerName);
    } else if (entryMethod != null) {
      return methodName.equals(entryMethod);
    ...
    boolean regular =
        methodName.equals("main([Ljava/lang/String;)V")
            || methodName.equals("realMain([Ljava/lang/String;)V");
    regular =
        (methodName.equals("run()V")
  ...
  private static synchronized long[] getVitalExecState() {
    ...
    if (Profiler.callDepth) {
      ...
      /**
       * A subtraction of 4 from the stack trace length is done to account for the following 4
       * methods in the call stack: - getStackTrace - getVitalExecState - handleXLog - printlnXLog
       */
  ...
  private static synchronized void handleEnterLog(String insnId, String tag, EventType insnType) {
    long[] vitalState = getVitalExecState();

    final String runtimeSignature = RuntimeTypeProfiler.getEnterRuntimeSignature(null);
    TraceEvent event =
        EventBuilder.buildEnterExecEvent(
            ++count, tag, insnId, insnType, vitalState, runtimeSignature);
    printEventlog(event);
  }

  private static synchronized void handleInvokeLog(String insnId, String tag, EventType insnType) {
    long[] vitalState = getVitalExecState();

    final String runtimeSignature = RuntimeTypeProfiler.getInvokeRuntimeSignature();
    TraceEvent event =
        EventBuilder.buildInvokeInsnExecEvent(
            ++count, tag, insnId, insnType, vitalState, runtimeSignature);
    printEventlog(event);
  }

  private static synchronized void handleLog(String insnId, String tag, EventType insnType) {
    long[] vitalState = getVitalExecState();

    TraceEvent event = EventBuilder.buildInsnExecEvent(++count, tag, insnId, insnType, vitalState);
    printEventlog(event);
  }

  private static synchronized void handleArrayLog(
      String insnId,
      String tag,
      EventType insnType,
      int arrayrefId,
    ...
    TraceEvent event =
        EventBuilder.buildArrayInsnExecEvent(
            ++count, tag, insnId, insnType, vitalState, arrayrefId, index, elementId, length);
    printEventlog(event);
  }

  private static synchronized void handleVarLog(String insnId, String tag, String varId) {
    long[] vitalState = getVitalExecState();

    TraceEvent event =
        EventBuilder.buildVarInsnExecEvent(
            ++count, tag, insnId, EventType.$var$, vitalState, varId);
    printEventlog(event);
  }

  private static synchronized void handleFieldLog(
      String insnId, String tag, String fieldId, String fieldOwnerId) {
    long[] vitalState = getVitalExecState();

    TraceEvent event =
        EventBuilder.buildFieldInsnExecEvent(
            ++count, tag, insnId, EventType.$field$, vitalState, fieldId, fieldOwnerId);
    printEventlog(event);
  }

  private static synchronized void handleArgLog(
      String argType, String index, EventType type, boolean isFirst, boolean isLast) {
    ...
    REAL_OUT.print(argType + "," + index + "," + type.toString() + (isLast ? "\n" : ","));
  }

  private static synchronized void printEventlog(TraceEvent event) {
